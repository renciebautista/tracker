...
{
    // Database connection string (web.config to configure), you can dynamically change the connectionString supports multiple databases.
    ...
    //Records /// <returns> effects </ returns> 
    ...
    //Execute multiple SQL statements implement a database transaction. 
    /// <summary>
    /// Execute multiple SQL statements implement a database transaction. 
    /// </summary>
